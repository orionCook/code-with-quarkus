...
//    DockerClient dockerClient = DockerClientFactory.instance().client();
    try {
      container = new LocalStackContainer(LOCALSTACK_IMAGE_NAME).withServices(LocalStackContainer.Service.SSM);
      container.start();
      ...
      properties.put("parameters.path", "/quarkus/is/awesome/");

      return properties;
    } catch (Exception e) {
      throw new RuntimeException("Cloud not start localstack server", e);
    }
  }
